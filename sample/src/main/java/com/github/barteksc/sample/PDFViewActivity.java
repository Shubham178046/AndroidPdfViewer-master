...
public class PDFViewActivity extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener,
    ...
    private void displayFromRemote() {
        URLLOAD loadurl = new URLLOAD();
        loadurl.execute("https://admin.gailgaspng.com/Upload/PDFs/GAILGasInvoice-4000274839-3919165.pdf");
    }

    public class URLLOAD extends AsyncTask<String, Void, InputStream> {
        @Override
